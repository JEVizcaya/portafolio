...
class PortfolioChat {
    ...
    async sendMessage() {
        ...
        try {
            ...
            // Llamar a la API
            const response = await this.callChatAPI(message);        console.log('Processing API response...');
        console.log('API response:', response);
        
        if (response.success) {
            console.log('Success response, adding message:', response.message);
        ...
        try {
            ...
            if (data.success) {
                ...
                return {
                    success: true,
                    message: data.response  // Backend returns 'response', frontend expects 'message'
                };
            } else {
